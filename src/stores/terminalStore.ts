...
const SUBAGENT_CODEX_LATE_TRANSCRIPT_CLOSE_DELAY_MS = 10000;
...
export const useTerminalStore = create<TerminalStore>((set, get) => ({
  ...
  finishSubagentTranscript: (payload) => {
    ...
    const closeDelayMs =
      payload.source === "codex" && trimOptional(payload.agentTranscriptPath)
        ? SUBAGENT_CODEX_LATE_TRANSCRIPT_CLOSE_DELAY_MS
