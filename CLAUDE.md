...
This project is indexed by GitNexus as **CLI-Manager** (2329 symbols, 3794 relationships, 135 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
