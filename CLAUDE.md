...
This project is indexed by GitNexus as **CLI-Manager** (9932 symbols, 19322 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
