...
This project is indexed by GitNexus as **CLI-Manager** (6924 symbols, 12851 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
