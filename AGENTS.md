...
This project is indexed by GitNexus as **CLI-Manager** (10334 symbols, 19432 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
