...
This project is indexed by GitNexus as **CLI-Manager** (6867 symbols, 12440 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
