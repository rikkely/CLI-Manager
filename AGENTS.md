...
This project is indexed by GitNexus as **CLI-Manager** (1980 symbols, 3231 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
