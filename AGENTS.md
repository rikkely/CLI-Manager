...
This project is indexed by GitNexus as **CLI-Manager** (2260 symbols, 3668 relationships, 124 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
